...
_source_id: `civil-engineering-pack/raw/laws/시설물안전법.txt`_

# 시설물의 안전 및 유지관리에 관한 특별법 — 출처: https://www.law.go.kr/DRF/lawService.do?OC=ducut91&target=law&MST=266683&type=XML — 수집일: 2026-05-28

[메타] 공포일자: 20241203 | 시행일자: 20251204 | 소관부처: 국토교통부
...
제25조(위험표지의 설치 등)
① 관리주체는 안전점검등을 실시한 결과 해당 시설물에 중대한결함등이 있거나 제16조에 따라 안전등급을 지정한 결과 해당 시설물이 긴급한 보수ㆍ보강이 필요하다고 판단되는 경우에는 해당 시설물에 위험을 알리는 표지를 설치하고, 방송ㆍ인터넷 등의 매체를 통하여 주민에게 알려야 한다. <개정 2019.8.20>
...
③ 관리주체는 제1항과 제2항에 따라 안전점검, 긴급안전점검 및 정밀안전진단을 국토안전관리원, 안전진단전문기관 또는 안전점검전문기관에 대행하게 하는 경우에는 안전상태를 사실과 다르게 진단하게 하거나, 결과보고서를 거짓으로 또는 부실하게 작성하도록 요구해서는 아니 된다. <신설 2019.8.20, 2020.6.9, 2024.1.16>
④ 제2항에 따라 국토안전관리원이나 안전진단전문기관이 정밀안전진단을 실시할 때에는 관리주체의 승인을 받아 다른 안전진단전문기관과 공동으로 정밀안전진단을 실시할 수 있다. <개정 2019.8.20, 2020.6.9>
...
② 제1항에 따른 관리주체는 성능평가를 국토안전관리원과 안전진단전문기관에게 대행하게 할 수 있다. <개정 2020.6.9>
